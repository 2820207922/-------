...
const router = new VueRouter({
    ...
    routes: [
        ...
        },
        {
            path: '/formsystem',
            name: '/formsystem',
            component: () => import('@/views/formsystem/index')
        },
        {
            path: '/findform',
            name: '/findform',
            component: () => import('@/views/findform/index')
        },
        {
            path: '/surveillance',
            name: '/surveillance',
            component: () => import('@/views/surveillance/index')
        },
        {
            path: '/operateform',
            name: '/operateform',
            component: () => import('@/views/operateform/tableTemplateTest')
        },
